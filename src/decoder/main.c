...
int main()
{
    ...
    read_ldpc_file(&code, "code6x6.txt"); //../code/test_code/code_rand_proto_3x6_400_4.txt
    ...
    layered_dec_setup(&code, "layer6x6.txt"); //../code/test_code/layer_rand_proto_3x6_400_4.txt
    ldpc_decode_layered(&code, llr_in, llr_out, 10, 0);
    ...
    ldpc_decode(code, llr_in, llr_out, 10, 0);
